<div style="font-family: 'Vazir',serif">
    ...
    @section('title')
        <title>گانر پارت-قطعات یدکی </title>
    ...
    @section('content')
        ...
        {{-- kia--}}
        <section class="page-section  " id="tag" >
            <div class="row justify-content-center">
                <div class="col-lg-6 m-auto">
                    <section class="page-section" id="tag">
                        <div class="container">
                            <div class="text-right">
                                <h4 class=" text-secondary mb-0 d-inline-block">قطعات یدکی-{{$tag->name}}</h4>

                            </div>
                            <hr style="color: #1a252f">
                            <div class="row">

                                @foreach($commos as $commo)
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12 mb-1">
                                        <div class="thumbnail text-center">
                                            <span class="#"></span>
                                            <a href="{{asset("/commodity/{$commo->id}")}}" target="_blank">
                                                <img class="img-responsive img-fluid imglazyload card-img-top" src="{{asset("$commo->image_url")}}" style="display: block; opacity: 0.99;" alt="">
                                            </a>
                                            <div  style="width: auto; height: 75px; display: block"  >
                                                <a href="{{asset("/commodity/{$commo->id}")}}" target="_blank">
                                                    ...
                                                    <h5 class=" mt-2" >{{$commo->name}}</h5>

                                                </a>
                                            </div>
                                            <a href="{{asset("/commodity/{$commo->id}")}}"><span class="text-success bg-light">جهت اطلاع از قیمت تماس بگیرید</span></a><br><br>
                                            ...
                                            <a href="{{asset("/commodity/{$commo->id}")}}" onclick="compare_add(2330);" class="btn btn-info btn-sm">
