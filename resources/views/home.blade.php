    ...
    <div class="container">
        <ul class="navbar-nav ml-auto">
            <li class="nav-item mx-0 mx-lg-1">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">MDBI</a>
            </li>
            @if(auth()->check())
                <li class="nav-item mx-0 mx-lg-1">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">محصولات</a>
                </li>
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#about">درباره ما</a>
                </li>
                <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#contact">تماس با ما</a>
                </li>
...
{{--            <!-- Masthead Avatar Image--><img class="img-fluid" src="assets/img/gun.png" alt="Log Cabin"/>--}}
            <!-- Masthead Heading-->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-md-6 col-lg-4 mb-5">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal0">
                        ...
                        </div><img class="img-fluid" src="assets/img/gun.png" alt="Log Cabin"/>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4 mb-5">
                    ...
                    <div class="container">
                        <div class="row justify-content-center">
                            <div class="col-lg-8">
                                ...
                                <!-- Portfolio Modal - Image--><img class="img-fluid rounded mb-5" src="assets/img/gun.png" alt="Log Cabin"/>
