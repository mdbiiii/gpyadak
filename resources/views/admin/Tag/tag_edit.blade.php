        ...
        <div class="container d-flex align-items-center flex-column">
            <div class="container" >
                ...
                <div class="row justify-content-center" style="font-family: 'Vazir', sans-serif;">
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">{{ __('بروزرسانی کلمات کلیدی') }}</div>

                            <div class="card-body">
                                <form method="POST" action="{{asset("/admin/tag/{$tag->id}/edit")}}" enctype="multipart/form-data">
                                    @csrf
                                    @method('put')
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input id="name" type="text" class="form-control @error('name') is-invalid @enderror " name="name" value="{{$tag->name}}"  >
