        ...
        <section class="page-section bg-dark text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading d-inline-block text-success">پیگیری سفارش</h2>
                </div>
                <hr>
                ...
                <div class="row">
                    <div class="col-lg-12 ml-auto" dir="rtl">
                        <p class="pre-wrap lead text-justify" >شما مشتریان و همراهان عزیز می توانید سفارشات خود را از طریق راه های ارتباطی قسمت تماس با ما پیگیری کنید.</p>
                    </div>
                </div>
            </div>
        </section>
