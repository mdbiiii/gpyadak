<div style="font-family: 'Vazir',serif">
    ...
    @section('meta')
        ...
        <meta name="description" content="شرایط ارسال">
        <meta name="author" content="">
        <title>گانر پارت:شرایط ارسال</title>
    @endsection
    @section('content')
        ...
        <section class="page-section bg-dark text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading d-inline-block text-success">شرایط ارسال</h2>
                </div>
                <hr>

                <!-- About Section Content-->
                <div class="row">
                    <div class="col-lg-10 ml-auto text-justify" dir="rtl">
                        <ul>
                            <li>
                                    مجموعه گانر پارت جهت ارائه خدمات مطلوب همواره از سفارش تا تحویل کالا همراه شماست.
                               </li>
                            <li>
                                    از این رو تحویل کالا بصورت دقیق و اکسپرس انجام می شود.
                               </li>
                            <li>
                                    ابتدا آدرس دقیق تحویل کالا از مشتری دریافت می شود. سپس تحویل برای مشتریان شهر تهران نهایت سه ساعت و برای مشتریان شهرستان متناسب با مسافت حداکثر تا سی ساعت صورت می گیرد.
                               </li>
                        </ul>
