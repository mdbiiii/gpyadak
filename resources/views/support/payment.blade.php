<div style="font-family: 'Vazir',serif">
    ...
    @section('meta')
        ...
        <meta name="description" content="شرایط پرداخت">
        <meta name="author" content="">
        <title>گانر پارت:شرایط پرداخت</title>
    @endsection
    @section('content')
        ...
        <section class="page-section bg-dark text-white mb-0" id="about">
            <div class="container">
                ...
                <div class="text-center">
                    <h2 class="page-section-heading d-inline-block text-success">شرایط پرداخت</h2>
                </div>
                <hr>

                <!-- About Section Content-->
                <div class="row">
                    <div class="col-lg-12 ml-auto text-justify" dir="rtl">
                        <ul>
                            <li><h3>اگر محل تحویل محصول خریداری شما تهران باشد می توانید از طروق زیر پرداخت خود را انجام دهید :</h3>
                                <ol>
                                    <li><h5> پرداخت به صورت کارت به کارت</h5><br>
                                        پس از انتخاب لوازم یدکی مورد نظر خود شماره کارت مجموعه  به مشتریان داده می شود.

                                        مبلغ کامل محصول به شماره کارت فرستاده شده انتقال دهید و عکس رسید آن را به شماره واتساپ یا تلگرام ارسال کنید.

                                        سپس محصول شما به آدرس تعیین شده توسط شما ارسال می شود.</li>
                                    <br>
                                    <li><h5>پرداخت درب محل</h5><br>
                                        پس از انتخاب لوازم یدکی مورد نظر محصول توسط پیک گانر پارت بهمراه دستگاه کارتخوان سیار به محل مورد نظر شما ارسال می شود.

                                        پس از رسیدن پیک و چک کردن مرسوله، مبلغ محصول از طریق کارتخوان سیار از شما دریافت می شود.</li>
                                    <br>
                                    <li><h5>خرید حضوری</h5><br>
                                        پس از انتخاب لوازم یدکی مورد نظر برای دریافت محصول و پرداخت به دفتر فروش گانر پارت به نشانی

                                         ما مراجعه نمایید.</li>
                                </ol>
                            </li>
                            <hr>
                            <li><h3>اگر محل تحویل محصول خریداری شما خارج از تهران باشد می توانید از طروق زیر پرداخت خود را انجام دهید:</h3>
                                <ol>
                                    <li><h5> پرداخت به صورت کارت به کارت</h5><br>
                                        پس از انتخاب لوازم یدکی مورد نظر خود شماره کارت مجموعه  به مشتریان داده می شود.
                                        ...
                                        سپس محصول شما به آدرس تعیین شده توسط شما ارسال می شود.</li>
                                    <br>
                                    <li><h5>پرداخت بیعانه</h5>br
                                        پس از انتخاب لوازم یدکی مورد نظر خود ۱۰% کل مبلغ محصول و هزینه ارسال محصول را به شماره کارتی که همکاران ما در اختیار شما قرار می دهند پرداخت کنید و عکس رسید پرداخت را به شماره واتساپ یا تلگرام ارسال کنید.

                                        سپس محصول شما به آدرس تعیین شده توسط شما ارسال می شود.

                                        پس از رسیدن محصول به محل مورد نظر شما و چک کردن کامل محصول ۹۰% باقی مبلغ محصول را به همان شماره کارت پرداخت نموده و عکس رسید آن را به شماره واتساپ یا تلگرام ارسال کنید</li>
                                </ol>
                            </li>
                        </ul>
                    </div>
